...
These are the company settings for ESLint and Prettier
...
* You can see all the [rules here](https://github.com/kaizenweb/eslint-config-kaizen/blob/master/.eslintrc.js)
